      ...
      <section className="flex flex-col w-full h-full px-4 py-6 sm:px-6 sm:py-8">
        ...
        <ul className="flex flex-col space-y-2 sm:space-y-3 overflow-y-auto scrollbar-thin" style={{ maxHeight: "400px" }}>
          ...
          {[
            ...
            <li key={idx} className="flex items-center space-x-2 sm:space-x-3 p-2 sm:p-3 rounded-xl hover:bg-gradient-to-r hover:from-gray-50 hover:to-blue-50 transition-all duration-200 cursor-pointer group">
              <div className="relative">
